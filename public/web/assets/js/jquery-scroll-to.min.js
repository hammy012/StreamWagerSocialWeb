!(function (e) {
  ...
  function n(e) {
    return t(e) || s.isPlainObject(e) ? e : { top: e, left: e };
  }
  return (
          ...
          if (null !== e) {
            ...
            s.each(h.axis.split(""), function (e, t) {
              var o = "x" === t ? "Left" : "Top",
                ...
                s = w.max(a, t);
              f
                ? ((d[r] = f[n] + (u ? 0 : i - c.offset()[n])),
                  h.margin &&
                    ((d[r] -= parseInt(l.css("margin" + o), 10) || 0),
                    (d[r] -= parseInt(l.css("border" + o + "Width"), 10) || 0)),
                  (d[r] += m[n] || 0),
                  h.over[n] &&
                    (d[r] += l["x" === t ? "width" : "height"]() * h.over[n]))
                : ((o = l[n]),
                  (d[r] =
                    o.slice && "%" === o.slice(-1)
                      ? (parseFloat(o) / 100) * s
                ...
                h.limit &&
                  /^\d+$/.test(d[r]) &&
                  (d[r] = d[r] <= 0 ? 0 : Math.min(d[r], s)),
                !e &&
                  1 < h.axis.length &&
                  (i === d[r] ? (d = {}) : x && (p(h.onAfterFirst), (d = {})));
            }),
              p(h.onAfter);
          }
          function p(e) {
    ...
    (w.max = function (e, t) {
      ...
      return y(e)
        ? ((o = "client" + t),
          (n = (r = e.ownerDocument || e.document).documentElement),
          (r = r.body),
          Math.max(n[i], r[i]) - Math.min(n[o], r[o]))
        : e[i] - s(e)[t.toLowerCase()]();
    }),
