...
<body
    class="
    @if (request()->is('profile*') || request()->is('user-friends*') || request()->is('your-friends*') || request()->is('user-profile*') || request()->is('friend-requests*') || request()->is('schedule*') || request()->is('user-schedule*')) activity bp-user my-activity my-account just-me buddypress bp-nouveau bbp-user-page single singular bbpress buddypress-template-default page page-id-371 logged-in wp-embed-responsive theme-beehive woocommerce-no-js beehive beehive-user buddychat-is-active bp-is-my-profile beehive-child elementor-default elementor-kit-588 title-bar-active beehive-social-layout panel-collapsed no-sidebar
