        ...
        <form method="POST" action="{{ route('admin.category-store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 from_part_2">
                    <label>Image</label><small style="color: red">* Ratio 1:1 </small>
                ...
                <div class="col-12 col-md-4 from_part_2">
                    <div class="form-group">
                        <img style="width: 200px; height: 200px; border: 1px solid; border-radius: 10px;" id="viewer" src="{{ isset($imagePath) ? asset($imagePath) : '' }}" alt="image" />
                    </div>
                </div>
            </div>
